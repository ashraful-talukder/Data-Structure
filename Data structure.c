...
void updatei(int pos,char id[12])
{
    struct node *p=head;
    if(pos==1)
    {
...
int main()
{
    ...
    for(a=0; a<1; a++)
    {
        ...
        printf("5. swap two student's position\n");
        ...
        else if(b==3)
        {
            ...
            if(k==1)
            {
                char nam[20];
                int p;
                printf("Enter the position no on the list you wanted to update: ");
                scanf("%d",&p);
        ...
        {
            printf("Enter the two serial numbers you want to swap: ");
            int y,z;
            scanf("%d%d",&y,&z);
            swap(y,z);
        }
